...
module.exports = function(eleventyConfig) {
  ...
  // robots.txt is generated by src/robots.njk (it changes with the launch switch)
  ...
  eleventyConfig.addFilter("partnersInCategory", (all, cat) =>
    (all || []).filter((p) => p.category === cat && p.enabled && p.url));
